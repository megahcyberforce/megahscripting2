...
if [[ -e /etc/wireguard/params ]]; then
	echo -e "${Info} WireGuard Already Installed In Your System !"
	exit 1
fi

echo -e "${Info} Wireguard"
...
iptables -t nat -I POSTROUTING -s 10.1.0.0/24 -o $SERVER_PUB_NIC -j MASQUERADE
...
# Tambahan
cd /usr/bin
wget -O addwg "https://raw.githubusercontent.com/wakleman/wakleman1/main/add/addwg.sh"
wget -O cekwg "https://raw.githubusercontent.com/wakleman/wakleman1/main/cek/cekwg.sh"
wget -O delwg "https://raw.githubusercontent.com/wakleman/wakleman1/main/del/delwg.sh"
wget -O renewwg "https://raw.githubusercontent.com/wakleman/wakleman1/main/renew/renewwg.sh"
chmod +x addwg
chmod +x delwg
chmod +x renewwg
cd
