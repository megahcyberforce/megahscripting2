...
# install v2ray
wget https://raw.githubusercontent.com/wakleman/wakleman1/main/addon/go.sh && chmod +x go.sh && ./go.sh
rm -f /root/go.sh
...
wget -O cert "https://raw.githubusercontent.com/wakleman/wakleman1/main/cert.sh"
chmod +x addvmess
chmod +x addvless
chmod +x addtrojan
chmod +x delvmess
