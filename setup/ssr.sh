...
Start_SSR(){
	check_pid
	wget -O /etc/init.d/ssrmu "https://raw.githubusercontent.com/wakleman/wakleman1/main/ssrmu"
...
# Download
wget -O /usr/bin/ssr https://raw.githubusercontent.com/wakleman/wakleman1/main/ssrmu.sh
chmod +x /usr/bin/ssr

wget -O /usr/bin/addssr https://raw.githubusercontent.com/wakleman/wakleman1/main/add/addssr.sh
chmod +x /usr/bin/addssr

wget -O /usr/bin/delssr https://raw.githubusercontent.com/wakleman/wakleman1/main/del/delssr.sh
&& chmod +x /usr/bin/delssr

wget -O /usr/bin/renewssr https://raw.githubusercontent.com/wakleman/wakleman1/main/renew/renewssr.sh
