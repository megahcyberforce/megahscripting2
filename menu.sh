...
echo -e  "  ║      [ 11 ] Change Port Of Some Service" | lolcat
echo -e  "  ║      [ 12 ] Reboot VPS" | lolcat
echo -e  "  ║      [ 13 ] Auto Reboot Menu" | lolcat
echo -e  "  ║      [ 14 ] Speedtest VPS" | lolcat
echo -e  "  ║      [ 15 ] Update Script To Latest Version" | lolcat
echo -e  "  ║"
echo -e  "  ╠═════════════════════════════════════════════════════════════════╗" | lolcat
