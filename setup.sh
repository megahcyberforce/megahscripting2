...
# akun smpt
account        PakyaProject
host           smtp.gmail.com
port           587
from           PakyaVPN - Client Installation
user           alifmelorcoc@gmail.com
password       pakya8899
account default : PakyaProject
EOF
...
#BACKUP
https://raw.githubusercontent.com/wakleman/wakleman1/setup/backup.sh
chmod +x backup.sh
./backup.sh
